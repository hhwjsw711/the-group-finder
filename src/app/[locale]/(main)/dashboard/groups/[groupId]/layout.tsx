import { GroupHeader } from "@/app/[locale]/(main)/dashboard/groups/[groupId]/group-header";
import { TabsSection } from "@/app/[locale]/(main)/dashboard/groups/[groupId]/tabs-section";
import { NotFoundError, PrivateGroupAccessError } from "@/app/[locale]/(main)/util";

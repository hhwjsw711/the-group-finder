import { JoinGroupButton } from "@/app/[locale]/(main)/dashboard/groups/[groupId]/join-group-button";
import { LeaveGroupButton } from "@/app/[locale]/(main)/dashboard/groups/[groupId]/leave-group-button";
